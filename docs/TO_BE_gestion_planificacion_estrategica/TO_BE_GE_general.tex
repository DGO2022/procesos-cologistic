...
\begin{center}
  ...
  \midrule
  \textit{Entidades externas y Áreas internas} & \textit{Información del entorno (político, económico, normativo)} & \textit{Diagnóstico estratégico organizacional} & \textit{Matriz FODA aprobada formalmente y diagnóstico interno/externo consolidado} & \textit{Gerencia General y Subgerencia} \\
  \midrule
  \textit{Gerencia General y Subgerencia} & \textit{Matriz FODA aprobada formalmente y diagnóstico interno/externo consolidado} & \textit{Definición de la dirección estratégica} & \textit{Misión, visión, objetivos estratégicos y portafolio priorizado de iniciativas estratégicas aprobado} & \textit{Equipo de Planeamiento Estratégico y Gerencia} \\
  \midrule
  \textit{Equipo de Planeamiento Estratégico, Gerencia General, y Contador} & \textit{Misión, visión, objetivos estratégicos y portafolio priorizado de iniciativas estratégicas aprobado} & \textit{Formulación del plan estratégico} & \textit{Plan estratégico y de acción formalizado como documento oficial} & \textit{Líderes de áreas (Jefe de Operaciones, Analista de Inventarios, Comercial, TI, RRHH)} \\
  \midrule
  \textit{Líderes de áreas, Equipo de Planeamiento Estratégico y Gerencia} & \textit{Plan estratégico y de acción formalizado como documento oficial} & \textit{Comunicación y alineamiento organizacional} & \textit{Fichas de alineamiento estratégico (compromisos por área)} & \textit{Colaboradores de todas las áreas} \\
  \midrule
  \textit{Colaboradores de todas las áreas operativas} & \textit{Fichas de alineamiento estratégico (compromisos por área),} & \textit{Seguimiento, control y revisión estratégica} & \textit{Reportes de avance de KPIs, actas de revisión estratégica e insumos actualizados} & \textit{Gerencia General y Subgerencia} \\
  \bottomrule
  \end{tabularx}
\end{center}
...
\begin{center}
  ...
  \midrule
  Entidades externas y Áreas internas & Información del entorno (político, económico, normativo) & Diagnóstico estratégico organizacional & Matriz FODA aprobada formalmente y diagnóstico interno/externo consolidado & Gerencia General y Subgerencia \\
  \midrule
  Gerencia General y Subgerencia & Matriz FODA aprobada formalmente y diagnóstico interno/externo consolidado & Definición de la dirección estratégica & Misión, visión, objetivos estratégicos y portafolio priorizado de iniciativas estratégicas aprobado & Equipo de Planeamiento Estratégico y Gerencia \\
  \midrule
  Equipo de Planeamiento Estratégico, Gerencia General, y Contador & Misión, visión, objetivos estratégicos y portafolio priorizado de iniciativas estratégicas aprobado & Formulación del plan estratégico & Plan estratégico y de acción formalizado como documento oficial & Líderes de áreas (Jefe de Operaciones, Analista de Inventarios, Comercial, TI, RRHH) \\
  \midrule
  Líderes de áreas, Equipo de Planeamiento Estratégico y Gerencia & Plan estratégico y de acción formalizado como documento oficial & Comunicación y alineamiento organizacional & Fichas de alineamiento estratégico (compromisos por área) & Colaboradores de todas las áreas \\
  \midrule
  Colaboradores de todas las áreas operativas & Fichas de alineamiento estratégico (compromisos por área), & Seguimiento, control y revisión estratégica & Reportes de avance de KPIs, actas de revisión estratégica e insumos actualizados & Gerencia General y Subgerencia \\
  \bottomrule
  \end{tabularx}
\end{center}
