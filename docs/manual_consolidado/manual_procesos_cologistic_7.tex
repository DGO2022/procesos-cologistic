...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.95\textwidth]{./images/mapa_procesos_nivel_0_cologistic.png}
  \caption{Mapa de Procesos Nivel 0 — Cadena de valor de Co Logistic SAC (procesos estratégicos, misionales y de apoyo)}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.95\textwidth]{./images/mapa_procesos_nivel_1_gestion_almacen.png}
  \caption{Mapa de Procesos Nivel 1 — Macroproceso Gestión de almacén}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.95\textwidth]{./images/mapa_procesos_nivel_1_arrendamiento.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{./images/bpmn_recepcion_p1_registro_pedido_ingreso.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{./images/bpmn_recepcion_p2_verificacion_conformidad.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{./images/bpmn_despacho_p1_registro_pedido_salida.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{./images/bpmn_despacho_p2_verificacion_conformidad.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{./images/bpmn_almacenamiento_p1_transferencia_ubicacion.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{./images/bpmn_almacenamiento_p2_reempaque.png}
...
\begin{center}
  ...
  \textbf{Proveedores} & \textbf{Elementos de Entrada} & \textbf{Proceso / Actividades} & \textbf{Elementos de Salida} & \textbf{Clientes} \\
  \midrule
  Cliente & Solicitud de repaletizado por código & 1. Solicitar repaletizado & Solicitud registrada & Auxiliar de almacén \\
  \midrule
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{./images/bpmn_acondicionamiento_p1_repaletizado.png}
...
\begin{center}
  ...
  \textbf{Proveedores} & \textbf{Elementos de Entrada} & \textbf{Proceso / Actividades} & \textbf{Elementos de Salida} & \textbf{Clientes} \\
  \midrule
  Cliente & Solicitud de reencajado por código & 1. Solicitar reencajado & Solicitud registrada & Auxiliar de almacén \\
  \midrule
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{./images/bpmn_acondicionamiento_p2_reencajado.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{./images/bpmn_facturacion_liquidacion_mensual.png}
